		...
		<div class="dvcontent">
			...
			<div>
				...
				<div class="tabs">
					<div class="hd">
						<ul style="">
							<li style="box-sizing: initial;-webkit-box-sizing: initial;" class="on">爱摄影</li>
									...
									<table class="table" id="tbRecord">
										...
										<tbody>
											...
											<tr>
												...
												<td class="edit"><button onclick="btn_edit(1)"><i class="icon-edit bigger-120"></i><a href="../edit/aisheying.php?id=<?=$date['id']?>">编辑</a></button></td>
												<td class="delete"><button onclick="btn_delete(1)"><i class="icon-trash bigger-120"></i><a href="../delete/aisheying.php?id=<?=$date['id']?>">删除</a></button></td>
											</tr>
										<?php }?>
										</tbody>
				...
				<div class="am-g">
					...
					<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4"
						...
						<form class="am-form am-form-horizontal"
							action="../htchuli/aisheying.php" method="post">
