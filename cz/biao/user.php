								...
								<div id="dv1">
									<table class="table" id="tbRecord">
										...
										<tbody>
											...
											$result=mysqli_query($conn,'SELECT * from `et`');
											...
											<tr>
												...
												<td class="delete"><button onclick="btn_delete(1)"><i class="icon-trash bigger-120"></i><a href="../delete/user.php?id=<?=$date['id']?>">删除</a></button></td>
											</tr>
										<?php }?>
										</tbody>
				...
				<div class="am-g">
					...
					<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4"
						...
						<form class="am-form am-form-horizontal"
							action="../htchuli/user.php" method="post">
						
							<div class="am-form-group">
								<label for="user-phone" class="am-u-sm-3 am-form-label">
									Phone/Email</label>
								<div class="am-u-sm-9">
									<input type="tel/email" id="user-phone" required
										placeholder="phone / email" name="tel">
								</div>
							</div>
