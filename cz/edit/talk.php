			...
			<div class="admin-content-body">
				...
				<div class="am-g">
					...
					<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4"
						...
						$result=mysqli_query($conn,"SELECT * from `talk` where `id`='$id'");
						$date=mysqli_fetch_assoc($result);


						?>
								<form class="am-form am-form-horizontal"
							action="../htchuli/talk.php?id=<?=$date['id']?>" method="post">
							...
							<div class="am-form-group">
								...
								<div class="am-u-sm-9">
									<input type="text" id="name questionBankName" required
										 name="pic" value="<?php echo $date['pic'];?>">
							...
							<div class="am-form-group">
									...
									<div class="am-u-sm-9">
										<input type="text" id="name questionBankName" required
											 name="name" value="<?php echo $date['name'];?>">
									</div>
							</div>
