				...
				<div class="am-g">
					...
					<div class="am-u-sm-12 am-u-md-8 am-u-md-pull-4"
						...
						<?php 
							 ...
							 $result=mysqli_query($conn,"SELECT * from `yuer` where `id`='$id'");
							 $date=mysqli_fetch_assoc($result);
						?>
							<form class="am-form am-form-horizontal" action="../htchuli/yuer.php?id=<?=$date['id']?>" method="post">
							<div class="am-form-group">
								<input type="hidden" name="type" value="2">
								<label for="user-intro" class="am-u-sm-3 am-form-label">
									链接</label>
									<div class="am-u-sm-9">
									<input type="text" name="lianjie" id="questionBankName" value=<?php echo $date['lianjie'];?>> 
